...
class Movable(Component):
    ...
    def move(self, dx, dy, dest_map=None):
        ...
        if dest_map:
            if dest_map.is_blocked_at(self.owner.x + dx, self.owner.y + dy):
                return False
    ...
    def move_towards(self, target_x, target_y, map):
        ...
        if not map.is_blocked_at(self.owner.x + dx, self.owner.y + dy):
            self.move(dx, dy)
    ...
    def move_astar(self, target, map):
        ...
        tcod.path_compute(my_path, self.owner.x, self.owner.y, target.x, target.y)
